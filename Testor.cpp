...
extern "C" __declspec(dllexport) int macroMain()
{
	...
	double V_start = 4;							 // Start of the Voltage of the pulse (Volts)
...
checkzero:
		...
		LithoSetSoft(lsNS5FPOutput1,(ii / V_step)); //Units are in Volts
										//This whole set checks for zeros and then corrects for them. It also averages the values by taking data 3 times for every voltage between 2 and -2.
